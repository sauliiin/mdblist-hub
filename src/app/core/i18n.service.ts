...
const PT: Record<string, string> = {
  ...
  'Sign in — Open Stream': 'Entrar — Open Stream',
  'Open Stream — your lists': 'Open Stream — suas listas',
  'Details — Open Stream': 'Detalhes — Open Stream',
  'Watch — Open Stream': 'Assistir — Open Stream',
